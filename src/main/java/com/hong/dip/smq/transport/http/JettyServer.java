...
public class JettyServer extends ServiceSupport{
	...
	public void addServlet(String mapping, Class<? extends Servlet> servlet){
		servletHander.addServletWithMapping(servlet, mapping);
	}
	@Override
